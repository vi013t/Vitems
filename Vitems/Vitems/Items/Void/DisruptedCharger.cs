...
public class DisruptedCharger : ModdedItem
{
	...
	protected override Tier Tier => Tier.Void;
    ...
    /// <summary>
    /// Creates the instance of the Disrupted Charger item. This should only be called once, when the item is initialized. 
    /// </summary>
    private DisruptedCharger()
    {
